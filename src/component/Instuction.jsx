...
const Instuction = () => {
  ...
  return (
    <>
      <div className="instruction-container text-red-700 container">
        <h1 className="text-black text-5xl text-center m-5">
          Instruction for quiz test.
        </h1>
        <ul className="list-disc ml-6 mb-6 leading-10 font-meduim text-xl">
          <li>
            <p>
              20 questions(MCQ) on <span className='font-semibold'>Html,Css and Javascript.</span>{" "}
            </p>
          </li>
          <li>
            <p>
        ...
        <button
          ...
          onClick={ () => {toggleFullSceen() ; routeChange() } }
        >
          Start
        </button>
      </div>
